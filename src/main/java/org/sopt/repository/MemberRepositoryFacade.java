...
public class MemberRepositoryFacade implements MemberRepository {
	private final FileMemberRepository fileMemberRepository = new FileMemberRepositoryImpl();
	private final MemoryMemberRepository memoryMemberRepository = new MemoryMemberRepositoryImpl();
